...
namespace HorrorEngine
{
    public class MusicManager : SingletonBehaviour<MusicManager>
    {
        ...
        public void Push(AudioClip clip, float volume, float duration)
        {
            ...
            if (isActiveAndEnabled && m_MainChannel.clip != clip)
        ...
        public void Pop(AudioClip clip, float duration)
        {
            ...
            if (isActiveAndEnabled && m_MainChannel.clip != nextClip.Clip)
        ...
        {            
            if (m_MainChannel.isPlaying)
                yield return Fade(m_MainChannel.volume, 0f, duration);
            ...
            if (toClip)
            {
                ...
                yield return Fade(m_MainChannel.volume, volume, duration);
            }
        }
